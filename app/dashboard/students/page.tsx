      ...
      <div className="space-y-4">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-slate-200">
            ...
            <p className="text-slate-500 font-medium">Memuat data murid...</p>
          </div>
        ) : error ? (
          <div className="flex flex-col items-center justify-center py-20 bg-red-50 rounded-3xl border border-red-200 text-red-700">
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
            ...
            <h3 className="text-xl font-bold text-slate-800">Murid tidak ditemukan</h3>
            <p className="text-slate-500 mt-1 max-w-xs text-center px-4">
            ...
            {filteredStudents.map((student) => (
              ...
              >
                <div className="p-6">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-800 text-lg leading-tight group-hover:text-green-700 transition-colors uppercase">
                      {student.fullname}
                    </h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="flex items-center justify-between p-6 border-b border-slate-100">
              <h2 className="text-xl font-bold text-slate-800">Tambah Murid Baru</h2>
              <button
            ...
            <div className="p-6 overflow-y-auto w-full">
              <form id="add-student-form" onSubmit={handleAddStudent} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-sm font-bold text-slate-700">Wali Murid / Orang Tua</label>
                    <select
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 outline-none focus:border-green-500 focus:ring-4 focus:ring-green-500/10 transition-all"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-sm font-bold text-slate-700">Unit Pendidikan</label>
                    <select
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 outline-none focus:border-green-500 focus:ring-4 focus:ring-green-500/10 transition-all"
