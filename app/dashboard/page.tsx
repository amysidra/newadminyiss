...
export default function DashboardPage() {
  return (
    <div className="h-[calc(100vh-160px)] flex flex-col items-center justify-center animate-in fade-in duration-700">
      ...
      <h1 className="mt-10 text-3xl font-bold text-slate-800 tracking-tight">
        Selamat Datang di Dashboard
      </h1>
      
      <p className="mt-4 text-slate-500 text-lg text-center max-w-md leading-relaxed px-6">
        Halaman ini akan segera diperbarui dengan <span className="text-[#1a7a4a] font-semibold">grafik interaktif</span> dan ringkasan data penting lainnya.
      </p>

      <div className="mt-12 flex items-center gap-3 px-6 py-4 bg-green-50 rounded-2xl border border-green-100 shadow-sm animate-bounce">
        <MousePointer2 className="w-5 h-5 text-[#1a7a4a]" />
