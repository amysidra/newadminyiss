    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f4f6f8] p-4">
      <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-10 max-w-md w-full text-center">
        ...
        <p className="text-slate-500 text-sm leading-relaxed mb-8">
          ...
          Halaman dashboard hanya dapat diakses oleh <strong>Administrator</strong>.
        </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            onClick={() => router.back()}
            className="w-full py-3 text-slate-600 font-bold rounded-xl hover:bg-slate-100 transition-all"
          >
            Kembali
          </button>
        </div>
